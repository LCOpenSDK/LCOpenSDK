...
@implementation LCMessageActivityIndicatorView
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super initWithCoder:aDecoder]) {
        _style = LCMessageActivityIndicatorViewStyleYellow;
...
- (void) setStyle:(LCMessageActivityIndicatorViewStyle)style {
    if (style == LCMessageActivityIndicatorViewStyleYellow) {
        _backgroundView.image = [UIImage imageNamed:@"lc_loading_orange_2.png"];
        _rotationView.image = [UIImage imageNamed:@"lc_loading_orange_1.png"];
    } else if (style == LCMessageActivityIndicatorViewStyleWhite) {
