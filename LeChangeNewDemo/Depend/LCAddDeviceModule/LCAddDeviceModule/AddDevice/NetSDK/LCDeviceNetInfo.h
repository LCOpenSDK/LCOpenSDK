...
@class LCDeviceDefinition;
@class LCOpenSDK_SearchDeviceInfo;
@interface LCDeviceNetInfo : NSObject <ISearchDeviceNetInfo>
...
@interface LCDeviceProductDefinition : NSObject <ISearchDeviceNetInfo>
...
@interface LCDeviceUserInfoDefinition : NSObject
...
//MARK: 设备登录信息
@interface LCNetLoginDeviceInfo : NSObject
