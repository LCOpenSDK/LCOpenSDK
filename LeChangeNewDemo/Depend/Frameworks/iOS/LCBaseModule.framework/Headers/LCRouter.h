//
//  LCRouter.h 在MGHRouter外面加一层 方便以后置换
//  Pods
//
...
extern NSString *const LCRouterParameterURL;
extern NSString *const LCRouterParameterCompletion;
extern NSString *const LCRouterParameterUserInfo;
 ...
 */
typedef id (^LCRouterObjectHandler)(NSDictionary *routerParameters);
