...
- (id)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super initWithCoder:aDecoder]) {
        _style = LCActivityIndicatorViewStyleYellow;
...
- (void) setStyle:(LCActivityIndicatorViewStyle)style {
    if (style == LCActivityIndicatorViewStyleYellow) {
        _backgroundView.image = [UIImage imageNamed:@"lc_loading_orange_2.png"];
        _rotationView.image = [UIImage imageNamed:@"lc_loading_orange_1.png"];
    } else if (style == LCActivityIndicatorViewStyleWhite) {
