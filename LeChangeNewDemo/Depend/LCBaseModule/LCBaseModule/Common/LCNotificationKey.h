...
UIKIT_EXTERN NSString *const SMBNotificationSelectDepartment;
///通知客户端选择部门结果，用于设备切换部门
UIKIT_EXTERN NSString *const SMBNotificationSelectDepartmentList;
///通知客户端选择成员结果(单选)，用于企业过户
UIKIT_EXTERN NSString *const SMBNotificationSelectEmployee;
///通知客户端选择成员结果(多选)，用于设置应用可见范围
UIKIT_EXTERN NSString *const SMBNotificationSelectEmployees;
///通知客户端首次创建部门后，去邀请员工
UIKIT_EXTERN NSString *const SMBNotificationInviteEmployee;

///有未读消息
UIKIT_EXTERN NSString *const SMBNotificationHaveUnReadApplyMessage;
///有新消息，需要刷新当前列表
UIKIT_EXTERN NSString *const SMBNotificationHaveNewMessageRecieve;
///无未读消息
UIKIT_EXTERN NSString *const SMBNotificationNoneUnReadApplyMessage;
///需要刷新企业列表
UIKIT_EXTERN NSString *const SMBNotificationCorpDataDidChange;
///需要刷新工作台右上角红色角标
UIKIT_EXTERN NSString *const SMBNotificationWorkpaltRetDotDidChange;

// MARK: - 视频监控
///重命名成功
UIKIT_EXTERN NSString *const SMBNotificationDeviceRenameSuccess;
/// 升级成功
UIKIT_EXTERN NSString *const SMBNotificationDeviceUpgradeSuccess;
/// WIFI刷新完成
