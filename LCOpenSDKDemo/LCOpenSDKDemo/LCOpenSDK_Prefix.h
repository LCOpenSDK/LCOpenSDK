...
/*UserModelView*/
#define USER_TITLE_TXT @"USER_TITLE"
#define USER_ACCOUNT_TIP_TXT @"ACCOUNT_TIP"
#define USER_ACCOUNT_BIND_TIP_TXT @"ACCOUNT_BIND_TIP"
#define BIND_USER_TXT @"BIND_USER"
#define WRONG_ACCOUNT_TXT @"WRONG_ACCOUNT"
#define BIND_SUCCEED_TXT @"BIND_SUCCEED"
#define BIND_TIMEOUT_TXT @"BIND_TIMEOUT"
#define BIND_FAILED_TXT @"BIND_FAILED"
#define ACCOUNT_NOTICE_TIP_TXT @"ACCOUNT_NOTICE_TIP"
...
#define RECORD_SAVE_SUCCESS @"RECORD_SAVE_SUCCESS"
#define RECORD_SAVE_FAILED @"RECORD_SAVE_FAILED"

#define PLAY_LOCAL_FILE @"PLAY_LOCAL_FILE"
...
/*LocalPlayView*/
#define LOCAL_PLAY_TITLE_TXT @"Local_PLAY_TITLE"

/*SoftAPConnectView*/
#define SOFTAP_CONNECT_TXT @"SOFTAP_CONNECT"
#define BIND_DEVICE_TXT @"BIND_DEVICE"
#define OPEN_DEVICE_HOTSPOT_TXT @"OPEN_DEVICE_HOTSPOT"
#define CONNECT_DEVICE_HOTSPOT_TXT @"CONNECT_DEVICE_HOTSPOT"
#define START_SOFTAP_CONNECT_TXT @"START_SOFTAP_CONNECT"
#define INPUT_POPWIN_INFO_TXT @"INPUT_POPWIN_INFO"
#define CHANGE_WIFI_TXT @"CHANGE_WIFI_IF_CONNECT_SUCCEED"
#define START_BIND_DEVICE_TXT @"START_BIND_DEVICE"
