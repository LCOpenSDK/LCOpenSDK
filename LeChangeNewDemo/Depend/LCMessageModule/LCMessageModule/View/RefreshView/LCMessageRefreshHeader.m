...
@implementation LCMessageRefreshHeader
#pragma mark - 重写方法
...
- (void)prepare
{
    ...
    self.pullString = @"mobile_common_pull_down_to_refresh".lcMessage_T;
    self.releaseString = @"mobile_common_data_loading".lcMessage_T;
    self.refreshString = @"mobile_common_data_loading".lcMessage_T;
