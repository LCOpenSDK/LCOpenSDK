...
#import "LCMediaRefreshFooter.h"
#import "LCMediaActivityIndicatorView.h"
#import <LCMediaBaseModule/NSString+MediaBaseModule.h>
#import <LCMediaBaseModule/LCMediaBaseDefine.h>

@interface LCMediaRefreshFooter ()
...
@implementation LCMediaRefreshFooter
...
- (void)prepare
{
    ...
    self.pullString = @"mobile_common_release_to_load".lcMedia_T;
    self.noMoreDataString = @"footer_no_more_data".lcMedia_T;
    self.refreshString = @"footer_refresh".lcMedia_T;
