...
#import "DHMessageActivityIndicatorView.h"

@implementation DHMessageActivityIndicatorView
...
- (id)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super initWithCoder:aDecoder]) {
        _style = DHMessageActivityIndicatorViewStyleYellow;
...
- (void) setStyle:(DHMessageActivityIndicatorViewStyle)style {
    if (style == DHMessageActivityIndicatorViewStyleYellow) {
        _backgroundView.image = [UIImage imageNamed:@"lc_loading_orange_2.png"];
        _rotationView.image = [UIImage imageNamed:@"lc_loading_orange_1.png"];
    } else if (style == DHMessageActivityIndicatorViewStyleWhite) {
